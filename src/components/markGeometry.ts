/* СГЕНЕРИРОВАНО scripts/gen-mark-geometry.mjs из brand/mishka-mark-source.svg — не править руками.
...
export const MARK_RATIO = 0.783226;

export const MARK_VIEWBOX = '0 0 23.16 29.57';
export const MARK_WIDTH = 23.16;
export const MARK_HEIGHT = 29.57;
export const MARK_TRANSFORM = 'translate(-353.55 -774.77)';
